class KpiBlock < ApplicationRecord
  ...
  def evolution
    evolution = ((call_ga_v4_kpi.reports.first.data.totals.first.values.first.to_f - call_ga_v4_kpi_diff.reports.first.data.totals.first.values.first.to_f) / call_ga_v4_kpi_diff.reports.first.data.totals.first.values.first.to_f) * 100
